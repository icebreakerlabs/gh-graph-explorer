        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    if G.is_empty() or sna_metrics.empty:\n",
                    ...
                    "if not G.is_empty() and not sna_metrics.empty:\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "        'network_nodes': G.number_of_nodes() if not G.is_empty() else 0,\n",
                    "        'network_edges': G.number_of_edges() if not G.is_empty() else 0,\n",
                    "        'network_density': nx.density(G) if not G.is_empty() else 0,\n",
                    "        'avg_clustering': nx.average_clustering(G) if not G.is_empty() else 0,\n",
                    "        'connected_components': nx.number_connected_components(G) if not G.is_empty() else 0\n",
                    "    }\n",
                    "    \n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    if sna_metrics.empty or G.is_empty():\n",
                    ...
                    "\n",
                    "# Generate insights\n",
                    "if not sna_metrics.empty and not G.is_empty():\n",
